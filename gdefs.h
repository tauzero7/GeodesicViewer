...
/*!  \file   gdefs.h
     \brief  Global definitions for the GeodesicViewer.
             ...
             If you have a big screen (1600x1200), then use
             "DEFINES += USE_BIG_SCREEN" in the gviewer.pro file.
             You can also change the size of the viewer yourself
             by adjusting the parameters in "GUI definitions".
*/
// --------------------------------------------------------------------------------
